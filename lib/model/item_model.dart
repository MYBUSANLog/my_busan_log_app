...
class ItemModel extends ChangeNotifier {
  ...
  Future<void> setAllItems({required String sortBy, required int start, required int count}) async{
    try {
      List<Item> newitems = await ItemHttp.fetchAllSortBy(sortBy, start, count);
